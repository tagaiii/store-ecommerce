# Generated by Django 3.1.1 on 2021-06-11 09:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sd', models.BooleanField(default=True, verbose_name='Слот для карт памяти')),
                ('sd_volume', models.CharField(max_length=255, verbose_name='Объем максимальной встраиваемой памяти')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('endurance', models.CharField(max_length=255, verbose_name='Автономность')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.category', verbose_name='Категория')),
            ],
            options={
                'abstract': False,
