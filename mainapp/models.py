...
class Order(models.Model):
    ...
    comments = models.TextField(verbose_name='Комментарии к заказу', null=True, blank=True)
    created_at = models.DateTimeField(auto_now=True, verbose_name='Дата создания заказа')
    order_date = models.DateField(verbose_name='Дата оформления заказа', default=timezone.now)
