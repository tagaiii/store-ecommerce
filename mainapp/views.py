...
from .models import Order, Category, Customer, Cart, CartProduct, Product
...
class CheckoutView(CartMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        stripe.api_key = "sk_test_51JHSvrAaUT2WUglyCYk9owecRG2fZuxfHO7JBvc64OmHmGzvqAFhP3J8Wsc3MjkRdkWYfRwzpuZOXT93ACVVZE1700uz2ge4Q3"
...
class MakeOrderView(CartMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.add_message(request, messages.INFO, 'Спасибо за покупку! Менеджер с Вами свяжется!')
